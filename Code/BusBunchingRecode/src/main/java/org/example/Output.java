...
public class Output {
    ...
    public static void timePositionFigure(int control_method, Simulator sim) throws Exception {
        ...
        String path = "D:\\PlotData1012\\" + method + ".csv";
//      + "_" + dateFormat.format(date)
    ...
    public void exportNumericalResults_numerical() throws Exception {
        ...
        String path_PBR = "D:\\PlotData1012\\NumericalExpeiments_PBR_"+ dateFormat.format(date) + ".csv";
        ...
        String path_AWT = "D:\\PlotData1012\\NumericalExpeiments_AWT_"+ dateFormat.format(date) + ".csv";
    ...
    public void exportNumericalResults_real() throws Exception {
        ...
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("HHmmss");
        String path_PBR = "D:\\PlotData1012\\RealWorldExpeiments_PBR_"+ dateFormat.format(date) + ".csv";
        File file_PBR = new File(path_PBR);
        OutputStreamWriter ow_PBR = new OutputStreamWriter(new FileOutputStream(file_PBR), "gbk");
        BufferedWriter bw_PBR = new BufferedWriter(ow_PBR);
        String path_AWT = "D:\\PlotData1012\\RealWorldExpeiments_AWT_"+ dateFormat.format(date) + ".csv";
        File file_AWT = new File(path_AWT);
        OutputStreamWriter ow_AWT = new OutputStreamWriter(new FileOutputStream(file_AWT), "gbk");
        BufferedWriter bw_AWT = new BufferedWriter(ow_AWT);
    ...
    public void exportNumericalResults_byStation() throws Exception{
        ...
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("HHmmss");
        String path_PBR = "D:\\PlotData1012\\StationExpeiments_PBR_"+ dateFormat.format(date) + ".csv";
        File file_PBR = new File(path_PBR);
        OutputStreamWriter ow_PBR = new OutputStreamWriter(new FileOutputStream(file_PBR), "gbk");
        BufferedWriter bw_PBR = new BufferedWriter(ow_PBR);
        String path_AWT = "D:\\PlotData1012\\StationExpeiments_AWT_"+ dateFormat.format(date) + ".csv";
        File file_AWT = new File(path_AWT);
        OutputStreamWriter ow_AWT = new OutputStreamWriter(new FileOutputStream(file_AWT), "gbk");
        BufferedWriter bw_AWT = new BufferedWriter(ow_AWT);
    ...
    public void sensitivityAnalysis_ArrivalRate() throws Exception{
        ...
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("HHmmss");
        String path_PBR = "D:\\PlotData1012\\SensitivityAnalysis_ArrivalRate-PBR_"+ dateFormat.format(date) + ".csv";
        File file_PBR = new File(path_PBR);
        OutputStreamWriter ow_PBR = new OutputStreamWriter(new FileOutputStream(file_PBR), "gbk");
        BufferedWriter bw_PBR = new BufferedWriter(ow_PBR);
        String path_AWT = "D:\\PlotData1012\\SensitivityAnalysis_ArrivalRate-AWT_"+ dateFormat.format(date) + ".csv";
        File file_AWT = new File(path_AWT);
        OutputStreamWriter ow_AWT = new OutputStreamWriter(new FileOutputStream(file_AWT), "gbk");
        BufferedWriter bw_AWT = new BufferedWriter(ow_AWT);
        bw_PBR.write(",");
    ...
    public void sensitivityAnalysis_Imax() throws Exception{
        ...
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("HHmmss");
        String path_PBR = "D:\\PlotData1012\\SensitivityAnalysis_Imax-PBR_"+ dateFormat.format(date) + ".csv";
        File file_PBR = new File(path_PBR);
        OutputStreamWriter ow_PBR = new OutputStreamWriter(new FileOutputStream(file_PBR), "gbk");
        BufferedWriter bw_PBR = new BufferedWriter(ow_PBR);
        String path_AWT = "D:\\PlotData1012\\SensitivityAnalysis_Imax-AWT_"+ dateFormat.format(date) + ".csv";
        File file_AWT = new File(path_AWT);
        OutputStreamWriter ow_AWT = new OutputStreamWriter(new FileOutputStream(file_AWT), "gbk");
        BufferedWriter bw_AWT = new BufferedWriter(ow_AWT);
        bw_PBR.write(",");
    ...
    public void sensitivityAnalysis_ImaxImin() throws Exception{
        ...
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("HHmmss");
        String path_PBR = "D:\\PlotData1012\\SensitivityAnalysis_ImaxImin-PBR_"+ dateFormat.format(date) + ".csv";
        File file_PBR = new File(path_PBR);
        OutputStreamWriter ow_PBR = new OutputStreamWriter(new FileOutputStream(file_PBR), "gbk");
        BufferedWriter bw_PBR = new BufferedWriter(ow_PBR);
        String path_AWT = "D:\\PlotData1012\\SensitivityAnalysis_ImaxImin-AWT_"+ dateFormat.format(date) + ".csv";
        File file_AWT = new File(path_AWT);
        OutputStreamWriter ow_AWT = new OutputStreamWriter(new FileOutputStream(file_AWT), "gbk");
        BufferedWriter bw_AWT = new BufferedWriter(ow_AWT);
        bw_PBR.write(",");
    ...
    public void sensitivityAnalysis_ConsiderationRangeU() throws Exception{
        ...
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("HHmmss");
        String path_PBR = "D:\\PlotData1012\\SensitivityAnalysis_U-PBR_"+ dateFormat.format(date) + ".csv";
        File file_PBR = new File(path_PBR);
        OutputStreamWriter ow_PBR = new OutputStreamWriter(new FileOutputStream(file_PBR), "gbk");
        BufferedWriter bw_PBR = new BufferedWriter(ow_PBR);
        String path_AWT = "D:\\PlotData1012\\SensitivityAnalysis_U-AWT_"+ dateFormat.format(date) + ".csv";
        File file_AWT = new File(path_AWT);
        OutputStreamWriter ow_AWT = new OutputStreamWriter(new FileOutputStream(file_AWT), "gbk");
        BufferedWriter bw_AWT = new BufferedWriter(ow_AWT);
        bw_PBR.write(",");
    ...
    public void runtimeAnalysis() throws Exception{
        ...
        Date date = new Date();
        SimpleDateFormat dateFormat= new SimpleDateFormat("HHmmss");
        String path = "D:\\PlotData1012\\Runtime_"+ dateFormat.format(date) + ".csv";
        File file = new File(path);
        OutputStreamWriter ow = new OutputStreamWriter(new FileOutputStream(file), "gbk");
        BufferedWriter bw = new BufferedWriter(ow);
        bw.write(",");
